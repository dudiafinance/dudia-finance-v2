...
export const creditCardBaseSchema = z.object({
  ...
  dueDay: z.coerce.number().int().min(1).max(28, "Para evitar problemas em meses curtos, use um dia entre 1 e 28"),
  closingDay: z.coerce.number().int().min(1).max(28, "Para evitar problemas em meses curtos, use um dia entre 1 e 28"),
